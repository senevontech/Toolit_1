  ...
  return (
    <div className="tool-container">
      <div className="space-y-8">
        <div>
          <p className="tool-subtitle uppercase tracking-[0.18em]">Image Tool</p>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="space-y-5">
            <section className="neu-card p-6">
              <h3 className="text-lg font-bold text-slate-100">{settingsTitle}</h3>
        ...
        {processed && processedPreviewUrl ? (
          <section className="neu-card p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <p className="tool-subtitle uppercase tracking-[0.18em]">Result</p>
                <h3 className="mt-2 text-2xl font-bold text-slate-100">{resultTitle}</h3>
                <p className="mt-2 text-sm leading-7 text-slate-400">
                  {processed.summary || "Your processed image is ready to preview and download."}
                </p>
              </div>
              <button
                type="button"
